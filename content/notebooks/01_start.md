...
![Physics by size and speed](../images/notes/week1/modern-physics-fields.png)<br>
...
You might have heard of the development of physics in the [Hellenistic age](https://en.wikipedia.org/wiki/Science_in_classical_antiquity#Hellenistic_age), when the Greeks used mathematics to study astronomical objects, or how [Newton's Laws of motion](https://en.wikipedia.org/wiki/Newton's_laws_of_motion) came to be. These are both examples of classical physics. 
...
when teaching mechanics, it implies that we can rarely venture beyond an idealized case
