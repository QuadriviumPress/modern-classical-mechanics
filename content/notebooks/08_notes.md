...
# Unit 8 - Notes: Oscillators and Modeling Oscillations
...
![Complex Conjugates](../images/notes/unit8/conjugates_graph.png)
...
This is the so-called [auxiliary Equation](https://en.wikipedia.org/wiki/Auxiliary_equation). This is a quadratic equation in $r$ and we can solve it using the quadratic formula:
