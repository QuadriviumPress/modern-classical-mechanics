...
How do we apply the coordinate system to the forces? We focus on the diagram above. We start by writing the sum of the forces. For this, we take the downward component $F_{gravity,y}$ to have magnitude $mg$, where $g$ is the magnitude of the acceleration due to gravity. 
...
There is generally no simple closed-form analytical solution to these coupled equations.
