...
Substituting $dY/d\alpha=\eta$ and $dY'/d\alpha=\eta'$ gives:
...
The time it takes for the bead to slide down the curve is given by:
...
This is the "cycloid" curve that the bead will follow to minimize the time it takes to slide down the track. We can plot this curve to visualize it.
