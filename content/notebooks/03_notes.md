...
# Unit 3 - Notes: Making Classical Models
...
![FBD of a falling ball](../images/notes/unit3/1d-ball-fbd.png)
...
![FBD of a simple harmonic oscillator](../images/notes/unit3/sho_horizontal.png)
...
![Framework for making models](../images/notes/unit3/physics-modeling-framework.png)
...
![FBD of a falling ball with air resistance](../images/notes/unit3/1d-ball-fbd-air.png)
...
As we will show in a later homework, the best choice is $v(t+\Delta t)$ which generally improves long-term energy behavior for conservative systems; it does not preserve energy exactly. 
```
...
This method was accidentally discovered by a high-school physics student called Abby Aspel. It was later explored by [Alan Cromer](https://en.wikipedia.org/wiki/Alan_Cromer), who wrote up this [method in the American Journal of Physics](https://aapt.scitation.org/doi/10.1119/1.10903).
