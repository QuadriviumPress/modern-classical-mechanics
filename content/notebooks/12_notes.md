...
# Unit 12 - Notes: Introduction to Lagrangian Mechanics 
...
![Position vector in polar coordinates](../images/notes/unit12/coordinate-system.png)
...
![Skateboarder on a circular track](../images/notes/unit12/skateboard.png)
...
![Free body diagram of skateboarder](../images/notes/unit12/skateboard-free-body.png)
...
These $N$ coordinates would give rise to a set of $N$ equations of motion (subject to potential reductions due to constraints). The Lagrangian can be expressed in terms of these generalized coordinates and velocities:
...
![Pendulum Diagram](../images/notes/unit12/plane-pendulum.png)
