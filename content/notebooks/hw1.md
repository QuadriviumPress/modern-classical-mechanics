...
* 4a (5pt) Show that the cross products are distributive $\boldsymbol{a}\times(\boldsymbol{b}+\boldsymbol{c})=\boldsymbol{a}\times\boldsymbol{b}+\boldsymbol{a}\times\boldsymbol{c}$.
...
2008](../images/activities/usain-bolt-2008-olympics-100-meter.jpg)](https://youtube.com/watch?v=93dC0o2aHto)
...
1. Initialize two three-dimensional $xyz$ vectors in the below cell using np.array([x,y,z]). Vectors are represented through arrays in Python
