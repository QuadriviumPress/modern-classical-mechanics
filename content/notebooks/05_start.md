...
[![Feynman on the units of energy](../images/notes/week5/feynman-on-units-of-energy.jpg)](https://youtube.com/watch?v=roX2NXDUTsM)
...
[![The Big Misconception About Electricity](../images/notes/week5/misconception-about-electricity.jpg)](https://youtube.com/watch?v=bHIhgxav9LY)
...
[![Point Particle and Real Models](../images/notes/week5/point-particle-and-real-models.jpg))](https://www.youtube.com/watch?v=fbiNKrqVajM)
...
Work is a concept closely related to energy, it describes the transfer of energy from one system to another. Our definition of work is macroscopic and thus will not be related to temperature. Increases in temperature are related to internal energy, and thus the microscopic motion of the particles in a system. As we consider a point particle moving from one location to another under a given force, we can define the work done by that force as:
