...
From the phase portrait, we can see that for $|x_0| > 1$, the solutions diverge to $|x|\to\infty$ in finite time. For $|x_0|<1$, solutions approach the stable critical point at $x=0$; the initial conditions $x_0=\pm1$ remain at their unstable fixed points.
